						...
						?>
							<table class="table table-bordered table-striped table-hover table-condensed">
								<tr class="warning">
									...
									<td>
										<p class="text-center"><strong>Task Description</strong></p>
									</td>
									<td>
										<p class="text-center"><strong>Rate</strong></p>
									</td>
									<td>
										<p class="text-center"><strong>Value</strong></p>
									</td>
									<td>
										<p class="text-center"><strong>Rate</strong></p>
									</td>
									<td>
										<p class="text-center"><strong>Delete</strong></p>
									</td>
								</tr>
								<?php
						...
						?>
							<table class="table table-bordered table-striped table-hover table-condensed">
								<tr class="success">
									...
									<td>
										<p class="text-center"><strong>Save</strong></p>
									</td>
									<td>
										<p class="text-center"><strong>Delete</strong></p>
									</td>
