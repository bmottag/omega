				...
				?>				
					<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables">
						...
						<?php						
							...
							echo "<tr>";
							echo "<td>" . $jobList[0]['job_description'] . "</td>";
...
<a href='<?php echo base_url('workorders/generaWorkOrderXLS/' . $idJob ); ?>' target="_blank"> <img src='<?php echo base_url_images('xls.png'); ?>' ></a>	
