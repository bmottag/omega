<script type="text/javascript" src="<?php echo base_url("assets/js/validate/template/workers.js"); ?>"></script>
					...
					<form  name="form" id="form" class="form-horizontal" method="post" >
                        ...
                        <table class="table table-striped table-hover table-condensed table-bordered">
                            ...
                            foreach ($workersList as $lista):
                                ...
                                $found = $ci->template_model->get_template_byIdworker_byIdSafety($idTemplate, $lista['id_user']);
