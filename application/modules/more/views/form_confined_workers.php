											...
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
														...
														<h4 class="modal-title">Worker Signature In</h4>
													</div>
													...
													<div id="out_<?php echo $data['id_job_confined_worker'] . "wModal"; ?>" class="modal fade" role="dialog">
														<div class="modal-dialog">
															<div class="modal-content">
																<div class="modal-header">
																	<button type="button" class="close" data-dismiss="modal">×</button>
																	<h4 class="modal-title">Worker Signature Out</h4>
																</div>
										...
										<td>
											<select name="safety_watch" id="safety_watch" class="form-control" required>
												...
												<?php for ($i = 0; $i < count($workersList); $i++) { ?>
													<option value="<?php echo $workersList[$i]["id_user"]; ?>" <?php if ($data["fk_id_safety_watch_user"] == $workersList[$i]["id_user"]) {
																													echo "selected";
