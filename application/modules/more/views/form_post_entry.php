						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select name="personnel_out" id="personnel_out" class="form-control" required>
									...
									<option value=1 <?php if($information[0]["personnel_out"] == 1) { echo "selected"; }  ?>>Yes</option>
									<option value=2 <?php if($information[0]["personnel_out"] == 2) { echo "selected"; }  ?>>No</option>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select name="equipment_removed" id="equipment_removed" class="form-control" required>
									<option value="">Select...</option>
									<option value=1 <?php if($information[0]["equipment_removed"] == 1) { echo "selected"; }  ?>>Yes</option>
									<option value=2 <?php if($information[0]["equipment_removed"] == 2) { echo "selected"; }  ?>>No</option>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select name="ppe_cleaned" id="ppe_cleaned" class="form-control" required>
									<option value="">Select...</option>
									<option value=1 <?php if($information[0]["ppe_cleaned"] == 1) { echo "selected"; }  ?>>Yes</option>
									<option value=2 <?php if($information[0]["ppe_cleaned"] == 2) { echo "selected"; }  ?>>No</option>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select name="permits_signed" id="permits_signed" class="form-control" required>
									<option value="">Select...</option>
									<option value=1 <?php if($information[0]["permits_signed"] == 1) { echo "selected"; }  ?>>Yes</option>
									<option value=2 <?php if($information[0]["permits_signed"] == 2) { echo "selected"; }  ?>>No</option>
								</select>
							</div>
						</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">      
							<div class="modal-header">        
								...
								<h4 class="modal-title">Post-entry Check – Signature</h4>      </div>      
