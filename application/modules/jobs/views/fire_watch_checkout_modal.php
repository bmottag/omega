...
<div class="modal-body">
	<form name="formCheckout" id="formCheckout" role="form" method="post" >
		...
		<input type="hidden" id="idFireWatch" name="idFireWatch" value="<?php echo $information?$information[0]["fk_id_job_fire_watch"]:""; ?>"/>
		<div class="row">
			<div class="col-sm-6">		
				<div class="form-group text-left">
					<label class="control-label" for="company">Full Name:</label>
					<input type="text" id="company" name="company" class="form-control" value="<?php echo $information[0]["first_name"] . " " . $information[0]['last_name']; ?>" disabled>
				</div>
			</div>
