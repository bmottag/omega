...
if($information[0]["supervisor_signature"]){ 
	...
	<a class="btn <?php echo $class; ?>" href="<?php echo base_url("incidences/add_signature/incident/supervisor/" . $information[0]["fk_id_job"] . "/". $information[0]["id_incident"]); ?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Supervisor Signature </a>
...
<a class="btn <?php echo $class; ?>" href="<?php echo base_url("incidences/add_signature/incident/coordinator/" . $information[0]["fk_id_job"] . "/" .  $information[0]["id_incident"]); ?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Coordinator Signature </a>
