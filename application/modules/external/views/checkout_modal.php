...
<div class="modal-header">
	...
	<h4 class="modal-title" id="exampleModalLabel">Check-Out Form</h4>
</div>
...
<div class="modal-body">
	<form name="formCheckout" id="formCheckout" role="form" method="post" >
		...
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="form-group text-left">
					<label class="control-label" for="contact">Time Check-In:</label>
		...
		<div class="form-group">
			<div class="row" align="center">
				<div style="width:50%;" align="center">
					<label class="control-label" for="contact">Time Check-Out:</label><br>
