<script type="text/javascript" src="<?php echo base_url("assets/js/validate/admin/vehicle_oil_change_hydrovac.js"); ?>"></script>
...
<div class="modal-body">
	<form name="form" id="form" role="form" method="post" >
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group text-left">
					<label class="control-label" for="hours">Engine current hours</label>
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group text-left">
					<label class="control-label" for="hours">Hydraulic pump hours</label>
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group text-left">
					<label class="control-label" for="hours">Blower current hours</label>
					<input type="text" id="hours3" name="hours3" class="form-control" placeholder="Hours/Kilometers" value="<?php echo $vehicleInfo[0]['hours_3']; ?>" required >
				</div>
			</div>
			...
			<div class="col-sm-6">
				<div class="form-group text-left">
					<label class="control-label" for="oilChange">Next Oil change</label>
					<input type="text" id="oilChange3" name="oilChange3" class="form-control" placeholder="Hours/Kilometers" value="<?php echo $vehicleInfo[0]['oil_change_3']; ?>" required >
				</div>
			</div>
		</div>
