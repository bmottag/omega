<script type="text/javascript" src="<?php echo base_url("assets/js/validate/admin/stock.js"); ?>"></script>
<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	<h4 class="modal-title" id="exampleModalLabel">Stock Form
	<br><small>Add/Edit Stock to use in vehicule maintenance.</small>
	</h4>
</div>
