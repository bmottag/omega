		...
		<div class="col-lg-12">				
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="frontAxle">Front Axle (Grader) <small class="text-primary">(Eje delantero)</small></label>
						<div class="col-sm-5">
							<label class="radio-inline">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="rearAxle">Rear Axle (Grader) <small class="text-primary">(Eje posterior)</small></label>
						<div class="col-sm-5">
							<label class="radio-inline">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="pivinPoints">Pivin points <small class="text-primary">(Bujes escualizables)</small></label>
						<div class="col-sm-5">
							<label class="radio-inline">
		...
		<div class="col-lg-12">				
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="blades">Blades (Dozer & Grader) <small class="text-primary">(Cuchillas)</small></label>
						<div class="col-sm-5">
							<label class="radio-inline">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="rubberTrucks">Rubber Tracks (Kubotas Only) <small class="text-primary">(Cadenas de caucho)</small></label>
						<div class="col-sm-5">
							<label class="radio-inline">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="drill">Drill (Skit Steer Only) <small class="text-primary">(Broca)</small></label>
						<div class="col-sm-5">
							<label class="radio-inline">
		...
		<div class="col-lg-12">				
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="tire">Tire / Lug Nuts / Presurre <small class="text-primary">(Presión de llantas)</small></label>
						<div class="col-sm-5">
							<label class="radio-inline">
