...
jQuery.validator.addMethod("campoNit", function(value, element, param) {
	...
	$( "#formWorker" ).validate( {
		rules: {
			...
			rh_factor:	 			{ required: true, maxlength:20 },
			worksfor:	 			{ required: true, minlength:2, maxlength:100 },
			position:	 			{ required: true, minlength:2, maxlength:100 },
			phone_number:	 		{ required: true, minlength:2, maxlength:20 },
			emergency_contact:		{ required: true, minlength:2, maxlength:150 },
			license:	 			{ required: true },
			license_number:			{ campoNit: "#license", number: true, maxlength:1},
		},
		errorElement: "em",
